...
options.register("xbins", 50, VarParsing.multiplicity.singleton, VarParsing.varType.int, "number of x bins for image")
options.register("ybins", 50, VarParsing.multiplicity.singleton, VarParsing.varType.int, "number of y bis for image")
